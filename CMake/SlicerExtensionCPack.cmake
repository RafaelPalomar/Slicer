...
if(NOT "${Slicer_CPACK_SKIP_GENERATE_EXTENSION_DESCRIPTION}")
  ...
  set(description_install_dir ${CMAKE_INSTALL_PREFIX}/${Slicer_SHARE_DIR})
  if(APPLE)
    set(description_install_dir ${CMAKE_INSTALL_PREFIX}/${Slicer_BUNDLE_EXTENSIONS_LOCATION}${Slicer_SHARE_DIR})
  endif()
