...
if(NOT DEFINED CTK_DIR AND NOT Slicer_USE_SYSTEM_${proj})
  ...
  if(Slicer_USE_PYTHONQT)
    ...
    ExternalProject_Add_FetchMethod(PROJECT PythonQt
      CAN_BE_OVERRIDDEN
      CMAKE_DEFINITION
    )
  ...
  #QtTesting Fetch method
  ExternalProject_Add_FetchMethod(PROJECT QtTesting
    CAN_BE_OVERRIDDEN
    CMAKE_DEFINITION
  )
  ...
  ExternalProject_Add_FetchMethod(
    PROJECT ${proj}
    GIT_REPOSITORY "${EP_GIT_PROTOCOL}://github.com/commontk/CTK.git"
    GIT_TAG "82cae5781621845486bad2697aed095f04cfbe76"
    CAN_BE_OVERRIDDEN
  )
